                                    ...
                                    <div class="text-center">
                                        <p class="tx-16 fw-bolder">
                                            ...
                                            @else
                                                Demo Account
                                            @endif</p>
                                        <p class="tx-12 text-muted">@if($admins)
                                                {{$admins->email}}
                                            @else
                    ...
                    <ul class="nav page-navigation">
                        ...
                        @if($admins->permission == 'Superadmin')
                            ...
                            <li class="nav-item">
                                ...
                                <div class="submenu">
                                    <ul class="submenu-item">
                                        <li class="nav-item"><a class="nav-link" href="{{ route('displayAdmin', ['id' => $admins]) }}">Admins</a></li>
...
{{--                                            <form action="{{route('createPermission')}}" method="POST" enctype="multipart/form-data">--}}
{{--                                                @csrf--}}
...
{{--                                            <td>{{$cata->id}}</td>--}}
{{--                                                <td><a class="btn btn-primary" href="#" data-toggle="modal" data-target="#updateModal{{$cata->id}}">{{$cata->permission_name}}</a></td>--}}
{{--                                            <td>--}}
...
{{--                                                    <div class="modal-content">--}}
{{--                                                        <div class="modal-header">--}}
{{--                                                            <h5 class="modal-title" id="updateModalLabel{{$cata->id}}">Update</h5>--}}
{{--                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">--}}
{{--                                                                <span aria-hidden="true">&times;</span>--}}
{{--                                                            </button>--}}
{{--                                                        </div>--}}
...
{{--                                                                @csrf--}}
{{--                                                                <input type="text" name="prod_id" value="{{$cata->id}}">--}}
{{--                                                                <div class="form-group">--}}
{{--                                                                    <label for="name{{$cata->id}}">Name</label>--}}
{{--                                                                    <input type="text" class="form-control" id="name{{$cata->id}}" name="name" value="{{ $cata->permission_name }}">--}}
{{--                                                                </div>--}}
...
{{--                                            </div>--}}
{{--                                            <td>--}}
{{--                                                <form action="{{ route('permission.delete') }}" method="POST" style="display:inline;">--}}
{{--                                                    @csrf--}}
{{--                                                    @method('DELETE')--}}
