        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Depo Pending Order</li>
                </ol>
            </nav>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="card-title mb-0">Depo Pending Order List</h4>
                                                            ...
                                                            <ul>
                                                                ...
                                                                @foreach($products as $product)
                                                                    @if($cata->invoice_id == $product->invoice_id)
                                                                        <li><strong>{{ $product->name }}</strong><br> - Price: {{ $product->cartoonprice }}৳<br> - Quantity: {{ $product->quantity }}</li>
                                                                    @endif
                                                                @endforeach
                                                            </ul>
                                                            <div class="form-group">
