        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="mb-0">Daily Sales Report for {{ \Carbon\Carbon::parse($date)->format('F j, Y') }}</h2>
                    <h3 class="mb-0">Total Sales: Tk. {{ number_format ($totalPrice,2) }}</h3><br>
                        <div>
                            <form method="GET" action="{{ route('daily-sales-report',['id'=>$admin->id]) }}" class="form-inline">
                        ...
                        <table class="table table-bordered" id="sales-report-table">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4">No sales found for this date.</td>
                                </tr>
                            @endforelse
                            </tbody>
                            @if(!$sales->isEmpty())
