                            ...
                            <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                                ...
                                <ul class="list-unstyled p-1">
                                    <li class="dropdown-item py-2">
                                        @if($admin)
                                            <a href="{{route('profile',['id'=>$admin])}}" class="text-body ms-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="mb-0">Monthly Sales Report for {{ \Carbon\Carbon::parse($date)->format('F Y') }}</h2>
                        <h3 class="mb-0">Total Sales: Tk. {{ number_format ($totalPrice,2) }}</h3><br>
                        <div>
                            <form method="GET" action="{{ route('monthly-sales-report',['id'=>$admin->id]) }}" class="form-inline">
                                <div class="form-group mr-2">

                                    <input type="month" id="date" name="date" value="{{ $date }}" class="form-control">
                                </div>
