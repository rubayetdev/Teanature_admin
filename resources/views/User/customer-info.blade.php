        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Customer Info List</li>
                </ol>
            </nav>
                                    ...
                                    @foreach($customer as $customers)
                                        <div class="card mb-3">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <img src="{{ asset('storage/'.$customers->image) }}" alt="image" class="img-fluid">
                                                    </div>
                                                    <div class="col-md-10">
...
{{--                                                            <input type="hidden" name="prod_id" value="{{$cata->id}}">--}}
                                                            <div class="form-group">
                                                                <label for="name{{$customers->id}}">User Name</label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="price{{$customers->id}}" name="price" value="{{ $customers->distric }}" readonly>
                                                            </div>
{{--                                                            <div class="form-group">--}}
...
{{--                                                            </div>--}}
                                                            <div class="form-group">
                                                                ...
                                                                <img src="{{asset('storage/'.$customers->image)}}" alt="{{$customers->name}}" width="50">
                                                            </div>
